...
@Component({
  ...
  [
    ...
    CommonModule,  // Necesario para las directivas y pipes comunes como ngIf, ngFor, etc.
    RouterLink,
    RouterOutlet
...
export class AppComponent implements OnInit {
  ...
  async loadEventosCreador() {
    try {
      this.eventos = await this.apiService.getEventoscreador();
      console.log(this.eventos)
    } catch (error) {
      console.error('Error al cargar eventos creador:', error);
    }
  }
